...
class CurrencyConverterApp:
    def __init__(self, root):
        ...
        self.from_currency_label = tk.Label(root, text="Convert from")
        ...
        self.to_currency_label = tk.Label(root, text="Convert to")
        ...
        self.amount_label = tk.Label(root, text="The amount to convert :")
